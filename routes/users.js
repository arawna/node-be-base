...
router.post("/register", async (req,res) => {
  ...
  try {
    ...
    if(body.password.length < Enum.PASS_LENGTH) {
      throw new CustomError(Enum.HTTP_CODES.BAD_REQUEST,"Validation Error!", "password length must be grater than " + Enum.PASS_LENGTH);
    }
...
router.post("/auth", async(req,res) => {
  try {
    ...
    if(!user) throw new CustomError(Enum.HTTP_CODES.UNAUTHORIZED,"Validation Error", "Email or passwprd wrong");

    if(!user.validPassword(password)) throw new CustomError(Enum.HTTP_CODES.UNAUTHORIZED,"Validation Error", "Email or passwprd wrong");
